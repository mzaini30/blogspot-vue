...
import require$$0$3, { readFileSync, writeFileSync } from 'fs';
...
const allPages = out.sync("dist/**/*.html");
for (let x of allPages) {
  let content = readFileSync(x).toString();
  content = content.replace('<script src="/alpine.js"><\/script>', '<script src="/alpine.js"><\/script><script src="/turbo.js"><\/script>').replace(/type="module" crossorigin=""/g, 'type="no-module" crossorigin=""').replace(/rel="modulepreload" crossorigin=""/g, 'rel="no-modulepreload" crossorigin=""');
